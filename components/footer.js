...
export default () => (
    <footer className={"footer" + " pt-35 pb-35 text-center"}>
        ...
        <div className={"findMe" + " d-flex j-center a-center"}>
            {/* github */}
            <a href="https://github.com/walidmahade" target="_blank" className={"icon"}>
            ...
            <a href="https://dev.to/walidmahade_45" target="_blank" className={"icon"}>
                <img src="https://d2fltix0v2e0sb.cloudfront.net/dev-badge.svg" alt="Mahade Walid's DEV Profile" />
            </a>
